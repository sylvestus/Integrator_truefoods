...
class UomGetController extends Controller
{
    ...
    public function getUomData(Request $request)
    {
        try {
            ...
            $url = "https://".$account_number.".restlets.api.netsuite.com/app/site/hosting/restlet.nl?script=customscript_get_uom&deploy=customdeploy_get_uom";

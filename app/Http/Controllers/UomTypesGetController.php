...
class UomTypesGetController extends Controller
{
    ...
    public function getUomTypes(Request $request)
    {
        try {
            ...
            $url = "https://".$account_number.".restlets.api.netsuite.com/app/site/hosting/restlet.nl?script=customscript_get_uom_types&deploy=customdeploy_get_uom_types";

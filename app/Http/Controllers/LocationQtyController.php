...
class LocationQtyController extends Controller
{
    ...
    public function getLocationQty(Request $request)
    {
        try {
            ...
            $url = "https://".$account_number.".restlets.api.netsuite.com/app/site/hosting/restlet.nl?script=customscript_get_location_qty&deploy=customdeploy_get_location_qty";
    ...
    public function getLocationQtySpecificItems(Request $request)
    {
        try {
            $company_id = $request->company_id;
            $environment = $request->environment;
            ...
            $url = "https://" . $account_number . ".restlets.api.netsuite.com/app/site/hosting/restlet.nl?script=customscript_specific_item_location_qty&deploy=customdeploy_specific_item_location_qty";
            $method = "POST";

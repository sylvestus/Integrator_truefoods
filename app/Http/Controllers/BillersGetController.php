...
class BillersGetController extends Controller
{
    ...
    public function getBillers(Request $request)
    {
        try {
            ...
            $url = "https://".$account_number.".restlets.api.netsuite.com/app/site/hosting/restlet.nl?script=customscript_get_billers&deploy=customdeploy_get_billers";

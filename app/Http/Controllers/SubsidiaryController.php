...
class SubsidiaryController extends Controller
{
    ...
    public function getSubsidiaryData(Request $request)
    {
        try {
            ...
            $url = "https://".$account_number.".restlets.api.netsuite.com/app/site/hosting/restlet.nl?script=customscript_get_subsidiary_data&deploy=customdeploy_get_subsidiary_data";

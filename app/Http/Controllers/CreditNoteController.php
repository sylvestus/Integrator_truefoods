...
class CreditNoteController extends Controller
{
    ...
    public function getCreditNotes(Request $request)
    {
        try {
            ...
            $url = "https://" . $company_data->account_number . ".restlets.api.netsuite.com/app/site/hosting/restlet.nl?script=customscript_credit_note_search_api&deploy=customdeploy_credit_note_search_api&invoiceNumber=".$credit_note_number."&startDate=".$start_date."&endDate=".$end_date."&customerId=".$customer_id."&repId=".$rep_id;
            $method = "GET";
            $data = "";
